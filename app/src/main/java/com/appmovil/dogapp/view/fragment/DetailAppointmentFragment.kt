 ...
 * Use the [DetailAppointmentFragment.newInstance] factory method to
...
class DetailAppointmentFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment DetailAppointmentFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            DetailAppointmentFragment().apply {
